...
public class mbvbargauge extends B4AClass.ImplB4AClass
  implements BA.SubDelegator
{
  ...
  public boolean _vvvvvvvvvvvvvvvvvvv5 = false;
    ...
    throws Exception
  {
    if (this.ba == null)
    {
      this.ba = new BA(paramBA, this, htSubs, "com.misricalendar.hijrical.mbvbargauge");
      if (htSubs == null)
      {
      ...
      if (this.ba.getClass().getName().endsWith("ShellBA"))
      {
        ...
        arrayOfObject[0] = "com.misricalendar.hijrical.mbvbargauge";
    ...
    throws Exception
  {
    ...
    this._vvvvvvvvvvvvvvvvvvv4 = 0;
    this._vvvvvvvvvvvvvvvvvvv5 = false;
  ...
  public String _initialize(BA paramBA, ActivityWrapper paramActivityWrapper, int paramInt1, int paramInt2, int paramInt3, int paramInt4, double paramDouble, int paramInt5, int paramInt6, boolean paramBoolean1, int paramInt7, int paramInt8, int paramInt9, boolean paramBoolean2)
    throws Exception
  {
    innerInitialize(paramBA);
    this._vvvvvvvvvvvvvvvvv6 = paramActivityWrapper;
    this._vvvvvvvvvvvvvvvvv0 = paramBoolean1;
    ...
    this._vvvvvvvvvvvvvvvvvv5 = (paramInt3 / 2.0D);
    this._vvvvvvvvvvvvvvvvvvv5 = paramBoolean2;
    ...
    this._vvvvvvvvvvvvvvvvv4.setTag("mbvs");
    ...
    this._vvvvvvvvvvvvvvvvvv2.drawLine(this._vvvvvvvvvvvvvvvvvv6, (float)this._vvvvvvvvvvvvvvvvvv5, (float)this._vvvvvvvvvvvvvvvvvv5, (float)this._vvvvvvvvvvvvvvvvvv5, (float)(this._vvvvvvvvvvvvvvvvv4.getHeight() - this._vvvvvvvvvvvvvvvvvv5), this._vvvvvvvvvvvvvvvvvv1);
    this._vvvvvvvvvvvvvvvvv5.Initialize(this.ba, "");
    PanelWrapper localPanelWrapper2 = this._vvvvvvvvvvvvvvvvv5;
    localPanelWrapper2.setColor(0);
    this._vvvvvvvvvvvvvvvvv4.AddView((View)this._vvvvvvvvvvvvvvvvv5.getObject(), 0, 0, paramInt3, paramInt3);
    ...
    localBitmapWrapper1.InitializeMutable(paramInt3, paramInt3);
    ...
    if (!paramBoolean1)
    {
      ...
      localABExtDrawing.drawCircle(this._cvs_disabled, (float)this._vvvvvvvvvvvvvvvvvv5, (float)this._vvvvvvvvvvvvvvvvvv5, (float)(paramInt3 / 9.0D), localABPaint3);
    }
    CanvasWrapper.BitmapWrapper localBitmapWrapper2 = new CanvasWrapper.BitmapWrapper();
    localBitmapWrapper2.InitializeMutable(paramInt3, paramInt3);
    ...
    if (!paramBoolean1)
    {
      localABPaint3.SetAlpha(255);
      localABPaint3.SetStyle(0);
      localABExtDrawing.drawCircle(this._cvs_pressed, (float)this._vvvvvvvvvvvvvvvvvv5, (float)this._vvvvvvvvvvvvvvvvvv5, (float)(paramInt3 / 6.0D), localABPaint3);
    }
    ...
    {
      localABPaint3.SetAlpha(255);
      localABExtDrawing.drawCircle(this._cvs_normal, (float)this._vvvvvvvvvvvvvvvvvv5, (float)this._vvvvvvvvvvvvvvvvvv5, (float)(paramInt3 / 6.0D), localABPaint3);
    }
    ...
    throws Exception
  {
    ...
    if (paramBoolean == true)
    {
      ...
      boolean bool1 = this._vvvvvvvvvvvvvvvvv0;
      if (bool1 != true)
        break label323;
      boolean bool3 = this._vvvvvvvvvvvvvvvvvvv5;
      if (bool3 != true)
        break label266;
      if (this._vvvvvvvvvvvvvvvvv5.getTop() < this._vvvvvvvvvvvvvvvvv4.getHeight() - this._vvvvvvvvvvvvvvvvv5.getHeight() - this._vvvvvvvvvvvvvvvvvv5)
        this._vvvvvvvvvvvvvvvvvv2.drawLine(this._vvvvvvvvvvvvvvvvvv6, (float)this._vvvvvvvvvvvvvvvvvv5, this._vvvvvvvvvvvvvvvvv5.getTop() + this._vvvvvvvvvvvvvvvvv5.getHeight(), (float)this._vvvvvvvvvvvvvvvvvv5, (float)(this._vvvvvvvvvvvvvvvvv4.getHeight() - this._vvvvvvvvvvvvvvvvvv5), this._vvvvvvvvvvvvvvvvvv1);
    }
    while (true)
    {
      return "";
      label266: if (this._vvvvvvvvvvvvvvvvv5.getTop() > this._vvvvvvvvvvvvvvvvvv5)
      {
        this._vvvvvvvvvvvvvvvvvv2.drawLine(this._vvvvvvvvvvvvvvvvvv6, (float)this._vvvvvvvvvvvvvvvvvv5, (float)this._vvvvvvvvvvvvvvvvvv5, (float)this._vvvvvvvvvvvvvvvvvv5, this._vvvvvvvvvvvvvvvvv5.getTop(), this._vvvvvvvvvvvvvvvvvv1);
        continue;
        label323: boolean bool2 = this._vvvvvvvvvvvvvvvvvvv5;
        if (bool2 == true)
          this._vvvvvvvvvvvvvvvvvv2.drawLine(this._vvvvvvvvvvvvvvvvvv6, (float)this._vvvvvvvvvvvvvvvvvv5, (float)(this._vvvvvvvvvvvvvvvvv5.getTop() + this._vvvvvvvvvvvvvvvvvv5), (float)this._vvvvvvvvvvvvvvvvvv5, (float)(this._vvvvvvvvvvvvvvvvv4.getHeight() - this._vvvvvvvvvvvvvvvvvv5), this._vvvvvvvvvvvvvvvvvv1);
        else
          this._vvvvvvvvvvvvvvvvvv2.drawLine(this._vvvvvvvvvvvvvvvvvv6, (float)this._vvvvvvvvvvvvvvvvvv5, (float)this._vvvvvvvvvvvvvvvvvv5, (float)this._vvvvvvvvvvvvvvvvvv5, (float)(this._vvvvvvvvvvvvvvvvv5.getTop() + this._vvvvvvvvvvvvvvvvvv5), this._vvvvvvvvvvvvvvvvvv1);
      }
    }
  }
  ...
  public int _vvvvvvvvvvvvvvvvv2()
    throws Exception
  {
    boolean bool = this._vvvvvvvvvvvvvvvvvvv5;
    if (bool == true)
    {
      long l2 = this._vvvvvvvvvvvvvvvvvv0 + this._vvvvvvvvvvvvvvvvvvv2;
      return (int)(l2 - Common.Round(this._vvvvvvvvvvvvvvvvv5.getTop() / ((this._vvvvvvvvvvvvvvvvv4.getHeight() - this._vvvvvvvvvvvvvvvvv5.getHeight()) / this._vvvvvvvvvvvvvvvvvvv2)));
    }
    long l1 = this._vvvvvvvvvvvvvvvvvv0;
    return (int)(l1 + Common.Round(this._vvvvvvvvvvvvvvvvv5.getTop() / ((this._vvvvvvvvvvvvvvvvv4.getHeight() - this._vvvvvvvvvvvvvvvvv5.getHeight()) / this._vvvvvvvvvvvvvvvvvvv2)));
  }

  public String _vvvvvvvvvvvvvvvvv3(int paramInt, boolean paramBoolean)
    throws Exception
  {
    this._vvvvvvvvvvvvvvvvvvv4 = paramInt;
    boolean bool1 = this._vvvvvvvvvvvvvvvvvvv5;
    if (bool1 == true)
    {
      PanelWrapper localPanelWrapper2 = this._vvvvvvvvvvvvvvvvv5;
      long l = this._vvvvvvvvvvvvvvvvv4.getHeight() - this._vvvvvvvvvvvvvvvvv5.getHeight();
      localPanelWrapper2.setTop((int)(l - Common.Round((paramInt - this._vvvvvvvvvvvvvvvvvv0) * ((this._vvvvvvvvvvvvvvvvv4.getHeight() - this._vvvvvvvvvvvvvvvvv5.getHeight()) / this._vvvvvvvvvvvvvvvvvvv2))));
      if (!paramBoolean)
        break label214;
      this._vvvvvvvvvvvvvvvvv5.SetBackgroundImage((Bitmap)this._cvs_normal.getBitmap().getObject());
    }
    while (true)
    {
      ...
      boolean bool2 = this._vvvvvvvvvvvvvvvvv0;
      if (bool2 == true)
        this._vvvvvvvvvvvvvvvvv7.setText(Integer.valueOf(_vvvvvvvvvvvvvvvvv2()));
      return "";
      PanelWrapper localPanelWrapper1 = this._vvvvvvvvvvvvvvvvv5;
      localPanelWrapper1.setTop((int)Common.Round((paramInt - this._vvvvvvvvvvvvvvvvvv0) * ((this._vvvvvvvvvvvvvvvvv4.getHeight() - this._vvvvvvvvvvvvvvvvv5.getHeight()) / this._vvvvvvvvvvvvvvvvvvv2)));
      break;
      label214: this._vvvvvvvvvvvvvvvvv5.SetBackgroundImage((Bitmap)this._cvs_disabled.getBitmap().getObject());
    }
  }
 ...
 * Qualified Name:     com.misricalendar.hijrical.mbvbargauge
