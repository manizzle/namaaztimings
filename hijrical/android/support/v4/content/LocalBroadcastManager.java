  ...
  public boolean sendBroadcast(Intent paramIntent)
  {
    ...
    while (true)
    {
      ...
      else
      {
        ...
        BroadcastRecord localBroadcastRecord = new BroadcastRecord(paramIntent, localArrayList2);
        localArrayList3.add(localBroadcastRecord);
        if (!this.mHandler.hasMessages(1))
          this.mHandler.sendEmptyMessage(1);
        return true;
        label489: label493: label508: 
        do
        {
          return false;
          j = 0;
