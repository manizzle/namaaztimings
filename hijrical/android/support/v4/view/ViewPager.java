...
public class ViewPager extends ViewGroup
{
  ...
  private void calculatePageOffsets(ItemInfo paramItemInfo1, int paramInt, ItemInfo paramItemInfo2)
  {
    ...
    else
    {
      for (int i9 = i5 + 1; ; i9++)
      {
        ...
        while (true)
          if ((i9 > localItemInfo4.position) && (i8 < this.mItems.size() - 1))
          {
            i8++;
    ...
    int m = paramItemInfo1.position - 1;
    float f3;
    float f4;
    label437: int n;
  ...
  private ItemInfo infoForCurrentScrollPosition()
  {
    ...
    while (true)
    {
      ...
      return localObject;
      label207: j = localItemInfo.position;
      f3 = f5;
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (i5 < i)
    {
      ...
      {
        int i14 = i12 + i3;
        int i15 = i14 + localView2.getMeasuredWidth();
        int i16 = i13 + localView2.getMeasuredHeight();
        localView2.layout(i14, i13, i15, i16);
        i4++;
        i5++;
        break;
        i12 = m;
  ...
  void populate(int paramInt)
  {
    ...
    label59: label490: label1004: label1264: 
    while (true)
    {
      return;
      i = 17;
      ...
      if (getWindowToken() != null)
      {
        ...
        if (localObject1 != null)
        {
          ...
          if (i10 >= 0)
          {
            localItemInfo5 = (ItemInfo)this.mItems.get(i10);
            float f2 = 2.0F - ((ItemInfo)localObject1).widthFactor + getPaddingLeft() / getClientWidth();
            i11 = this.mCurItem - 1;
            if (i11 >= 0)
            {
              if ((f1 < f2) || (i11 >= m))
        ...
        label1010: label1143: for (Object localObject2 = ((ItemInfo)localObject1).object; ; localObject2 = null)
        {
          localPagerAdapter1.setPrimaryItem(this, i5, localObject2);
          this.mAdapter.finishUpdate(this);
          ...
          for (int i7 = 0; i7 < i6; i7++)
          {
            ...
            localLayoutParams.childIndex = i7;
          ...
          for (localItemInfo5 = (ItemInfo)this.mItems.get(i10); ; localItemInfo5 = null)
          {
            i11--;
            break;
          }
  ...
  void setCurrentItemInternal(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2)
  {
    ...
    for (boolean bool = true; this.mFirstLayout; bool = false)
    {
  ...
  public void setPageTransformer(boolean paramBoolean, PageTransformer paramPageTransformer)
  {
    ...
    label54: label70: label75: label81: label87: label93: for (this.mDrawingOrder = j; ; this.mDrawingOrder = 0)
    {
      if (i != 0)
        populate();
      return;
